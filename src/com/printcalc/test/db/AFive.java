 ...
 * @ author bhupendra
 * 
 * Dummy class for testing help
 */
public class AFive implements GenericPaper {
	...
	private static final String paperType = "A5";

	public AFive(boolean jobType, int colorPrint, int blackAndWhitePrint,
			int totalPages) {
		super();
